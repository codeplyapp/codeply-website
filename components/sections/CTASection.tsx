...
export default function CTASection() {
  return (
    <section className="py-20 bg-[#0a001a]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-[#0a001a] via-[#27005D]/70 to-[#512B81]/70 border border-[#9400FF]/40 p-8 sm:p-12 text-center shadow-2xl">
            <div className="relative z-10 max-w-2xl mx-auto">
              ...
              <p className="text-sm sm:text-base text-[#e2ccff] mb-8 leading-relaxed">
